package com.laissonsilveira.realtime.chat;
...
public class ChatServerIntegrationTests {
    ...
    public void getChatMessage() throws Exception {
                ...
                session.subscribe("/topic/guestchats", new StompFrameHandler() {
                    ...
                    public void handleFrame(StompHeaders headers, Object payload) {
                        ...
                        try {
                            ...
                            assertEquals("User: Hello Spring", greeting.getContent());
                        } catch (Throwable t) {
                            failure.set(t);
                        } finally {
                            session.disconnect();
        ...
        this.stompClient.connect(
                "ws://localhost:{port}/realtime-chat",
                this.headers,
                handler,
                this.port);
